...
class RAGPreprocessor:
    def __init__(self, processed_data_path: str = "./dist"):
...
def main():
    ...
    parser.add_argument('processed_data_path', help='Path to processed data directory')
    args = parser.parse_args()
    
    preprocessor = RAGPreprocessor(args.processed_data_path)
